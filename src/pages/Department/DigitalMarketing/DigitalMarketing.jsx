...
const OUTCOMES = [
    ...
    { value: '4 months', label: 'Program duration' },
    { value: '8', label: 'Live platforms & tools' },
    { value: 'Live budget', label: 'Real campaign, not a mock' },
];
...
const MODULES = [
    {
        ...
        desc: 'Map the customer journey, define target personas, set SMART campaign goals, and learn the KPIs that separate a working strategy from guesswork.',
    },
    {
        number: '02',
        title: 'Search Engine Optimization',
        desc: 'Keyword research, on-page and technical SEO, and off-page link building — the fundamentals of ranking without paying for every click.',
    },
    {
        number: '03',
        title: 'Search & Paid Social Advertising',
        desc: 'Plan and run Google Ads (SEM) and Meta/Instagram/LinkedIn campaigns: audience targeting, bidding, retargeting, and A/B testing creative.',
    },
    {
        number: '04',
        title: 'Content & Social Media Strategy',
        desc: 'Build a content calendar and platform-specific strategy — blog pipelines, short-form video, and community management that actually gets engagement.',
    },
    {
        number: '05',
        title: 'Email Marketing & Automation',
        desc: 'List building and segmentation, campaign design, and automation workflows in Mailchimp and HubSpot, tested with split testing.',
    },
    {
        number: '06',
        title: 'Analytics & Reporting',
        desc: 'Set up GA4 and Google Search Console, track funnels and conversions, and turn campaign data into a report a client or manager will actually read.',
    },
];

const TOOLS = ['Google Ads', 'Meta Ads Manager', 'SEMrush', 'Ahrefs', 'GA4', 'Google Search Console', 'HubSpot', 'Mailchimp', 'Canva'];

const CAREERS = [
    { role: 'SEO Analyst', desc: 'Runs keyword research, on-page audits, and link-building campaigns to grow organic traffic.' },
    { role: 'Performance Marketer', desc: 'Plans and optimizes paid Search and Social campaigns against a target cost-per-acquisition.' },
    { role: 'Content & Social Media Marketer', desc: 'Owns the content calendar and platform strategy across blog, video, and social.' },
    { role: 'Marketing Analyst', desc: 'Builds GA4 dashboards and reports campaign performance back to stakeholders.' },
];

const GALLERY = [
    { url: 'https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?w=800&q=80', caption: 'Live campaign dashboards' },
    { url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80', caption: 'Data-driven strategy sessions' },
    { url: 'https://images.unsplash.com/photo-1611926653458-09294b3142bf?w=800&q=80', caption: 'Social media content creation' },
];
        ...
        <div className="bg-white text-gray-900">
            ...
            <section className="max-w-7xl mx-auto px-6 pt-14 pb-10 md:pt-20">
                <div className="flex items-center gap-2 text-[12.5px] text-gray-400 mb-8">
                    ...
                    <span>/</span>
                    <span className="text-[#356575]">Digital Marketing</span>
                </div>

                <span className="text-[11px] tracking-[0.15em] uppercase text-[#356575] font-medium">Department of Digital Marketing</span>
                <h1
                ...
                <p className="text-gray-500 text-[15.5px] leading-relaxed max-w-xl">
                    Grow brands, move markets, and master the algorithms. Learn the
                    strategy and the tools behind campaigns that convert — with a live
                    budget, not a simulation.
                </p>
            ...
            <section className="max-w-7xl mx-auto px-6 py-16 md:py-20 grid lg:grid-cols-[1.15fr_0.85fr] gap-12 items-center">
                <div>
                    ...
                    <p className="text-gray-500 text-[15px] leading-relaxed mb-4">
                        Digital marketing isn't just posting content — it's understanding
                        people, platforms, and performance metrics. This program builds
                        the strategic mindset and technical toolkit to run campaigns
                        that actually move the needle.
                    </p>
                    <p className="text-gray-500 text-[15px] leading-relaxed">
                        From SEO audits to paid social funnels, you'll graduate with a
                        live portfolio of real campaigns run on a real budget — not
                ...
                <div className="relative">
                    ...
                    <div className="absolute -bottom-5 -left-5 bg-white border border-[#d0e4e9] rounded-xl px-5 py-4 shadow-md">
                        ...
                        <p className="text-[13.5px] font-semibold text-[#1E3D47] mt-0.5">Google, Meta & HubSpot aligned</p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gray-50 py-16 md:py-20">
                <div className="max-w-7xl mx-auto px-6">
                    <SectionHeading eyebrow="In practice" title="Campaigns, content & results" />
            ...
            >
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
                    ...
                    <p className="text-white/60 text-[15px] mb-8 leading-relaxed">
                        Join the next batch of digital marketers building careers at agencies, startups, and established brands.
                    </p>
